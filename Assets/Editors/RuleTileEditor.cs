...
namespace UnityEditor {
    ...
    internal class RuleTileEditor : Editor {
        ...
        private const string s_This = "iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAVklEQVQokWNgGCjAiE1Q2V79P7rY3YM3MdSyYNMoXKuIzcz/6AagcPBoZGBgYGB423wfxQVwBiGN2AxgIqgaDxiimqkT2oQMQNeIVTPMAHQxbCls4AAAsuIpw5l4a2EAAAAASUVORK5CYII=";
        ...
        private static Texture2D[] s_OtherTileTypes;
        public static Texture2D[] otherTileTypes {
            get {
                if(s_OtherTileTypes == null) {
                    s_OtherTileTypes = new Texture2D[2];
                    s_OtherTileTypes[0] = Base64ToTexture(s_This);
                    s_OtherTileTypes[1] = Base64ToTexture(s_XIconString);
                }
                return s_OtherTileTypes;
            }
        }
        ...
        internal const float k_SingleLineHeight = 30f;
                    ...
                    if(x != 2 || y != 2) {
                        switch(tilingRule.m_Neighbors[index]) {
                            case RuleTile.TilingRule.Neighbor.This:
                                GUI.DrawTexture(r, otherTileTypes[0]);
                                break;
                            case RuleTile.TilingRule.Neighbor.NotThis:
                                GUI.DrawTexture(r, otherTileTypes[1]);
                                break;
                        }
